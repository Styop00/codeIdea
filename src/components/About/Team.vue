<template>
    <div class="div_container  px-5 grid md:grid-cols-2 gap-y-11 lg:grid-cols-12 justify-center lg:justify-between md:justify-center lg:gap-y-24 mt-3 lg:gap-x-12  ">
