<template>
    <div class="shadow-small-10 p-2">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm mb-3 leading-5 md:leading-6"> {{ article.body }} </p>
            <button @click="router.push({
                name: 'article', 
                params: {id: article_index},
            })" class="font-medium underline">Learn more</button>
        </div>
    </div>
...
<script setup>
    ...
    const props = defineProps(['article_index', 'article']);
