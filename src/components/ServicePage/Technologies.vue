<template>
  <div class="py-28 px-14 bg-white flex flex-col gap-14 justify-center items-center">
    <div class="font-bold lg:text-5xl md:text-3xl text-xl md:text-center lg:text-center" >Technologies we work in</div>
    <div class="flex flex-wrap lg:gap-16 gap-7  md:gap-14">
...
import iconicLogo from "../../images/iconic.png"
import vueLogo from "../../images/vue.png"
import nuxtLogo from "../../images/nuxt.png"
